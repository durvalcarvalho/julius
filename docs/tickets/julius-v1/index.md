...
| 002 | [Repositório stores](002-repository-stores.md) | — | S | pendente | `repositories/stores.py` |
...
| 007 | [Serviço catalog](007-service-catalog.md) | 002–004 | M | pendente | `services/catalog.py` (renomear, fundir, tag, conteúdo) |
