...
|---|---|---|---|---|---|
| 101 | [Parser — endereço](101-parser-store-address.md) | — | S | a fazer | `Receipt.store_address`, `_ADDRESS` |
...
| 112 | [CLI review + revisar](112-cli-review-and-revisar.md) | 109, 110 | M | a fazer | `cli/_review.py`, `julius produtos revisar [--sim]` |
